...
require('lazy').setup({
  ...
  -- HACK: extracted! this was a big one
  {
    ...
    config = function()
      ...
      vim.list_extend(ensure_installed, {
        ...
        'ruff', -- Use to format Python code
        'black', -- Used to format Python code
        'prettier', -- Used to format HTML/CSS/JS/TS
  ...
  -- HACK: not extracting
  { -- Install and configure Tokyonight, but don’t set as default
